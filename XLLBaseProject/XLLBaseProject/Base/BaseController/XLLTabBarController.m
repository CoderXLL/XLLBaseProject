...
#import "XLLFirstController.h"
#import "XLLSecondController.h"
#import "XLLThirdController.h"
...
- (void)addAllVCs
{
    [self setupChildVC:[[XLLFirstController alloc] init] title:@"首页" normalImage:[UIImage imageNamed:@"Dialog"] selectedImage:[UIImage imageNamed:@"Dialog_Selected"]];
    [self setupChildVC:[[XLLSecondController alloc] init] title:@"订单" normalImage:[UIImage imageNamed:@"Contact"] selectedImage:[UIImage imageNamed:@"Contact_Selected"]];
    [self setupChildVC:[[XLLThirdController alloc] init] title:@"我的" normalImage:[UIImage imageNamed:@"User"] selectedImage:[UIImage imageNamed:@"User_Selected"]];
}
